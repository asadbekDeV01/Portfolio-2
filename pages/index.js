...
import web3 from "../public/web.jpg";
      ...
      <main className=" bg-white px-10 dark:bg-gray-900 md:px-20 lg:px-40">
        <section className="min-h-screen">
          ...
          <div className="text-center p-10 py-10">
            ...
            <p className="text-md py-5 leading-8 text-gray-800 dark:text-gray-200 max-w-xl mx-auto md:text-xl">
              Programmer providing services for programming content needs. Join
              me below and let s get cracking!
            </p>
        ...
        <section className="py-10">
          <div>
            ...
            <p className="text-2xl py-2 w-[45%] leading-8 text-gray-800 dark:text-gray-200">
              As a developer, I ve developed interesting websites so far that I
              like...
            </p>
            <h4 className="text-xl mt-2">
              Click on the images and visit the websites
            </h4>
          </div>
